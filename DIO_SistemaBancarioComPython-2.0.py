...
def menu():
    menu = """\n
    ====== Bem vindo ao Banco Hoje! ========

    Por gentileza escolha sua opção:
...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques): #keyworld , forma nomeada
...
def exibir_extrato(saldo, /, *, extrato): #posicional saldo e nomeado extrato.
    print("\n================ EXTRATO ================\n")
...
def criar_usuario(usuarios):
    ...
    usuarios.append({"nome": nome, "data_nascimento": data_nascimento, "cpf": cpf, "endereco": endereco}) #aqui faz um dicionario
